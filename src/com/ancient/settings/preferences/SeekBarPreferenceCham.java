...
public class SeekBarPreferenceCham extends Preference implements SeekBar.OnSeekBarChangeListener {
    ...
    private static final String ANCIENTSETTINGSNS = "http://schemas.android.com/apk/res-auto";
    ...
    private void setValuesFromXml(AttributeSet attrs, Context context) {
        ...
        mUnitsLeft = getAttributeStringValue(attrs, ANCIENTSETTINGSNS, "unitsLeft", "");
        mUnitsRight = getAttributeStringValue(attrs, ANCIENTSETTINGSNS, "unitsRight", "");
        ...
        try {
            String newInterval = attrs.getAttributeValue(ANCIENTSETTINGSNS, "interval");
            if(newInterval != null)
